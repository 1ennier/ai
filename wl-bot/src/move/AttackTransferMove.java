...
/** This Move is used in the second part of each round. It represents the attack or transfer of armies from fromRegion to toRegion. If toRegion is owned by the
 * player himself, it's a transfer. If toRegion is owned by the opponent, this Move is an attack. */
...
public class AttackTransferMove extends Move {
	...
	public enum MOVE_TYPE {
		UNKNOWN, FIRST, NO_MATTER, LAST
	}

	private MOVE_TYPE type;

	public AttackTransferMove(String playerName, Region fromRegion, Region toRegion, int armies, MOVE_TYPE type) {
